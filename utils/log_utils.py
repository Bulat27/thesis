...
def log_values_sl(cost, grad_norms, epoch, batch_id, 
    ...
    # Log values to screen
    print('\nepoch: {}, train_batch_id: {}, loss: {}, avg_cost: {}'.format(epoch, batch_id, loss * opts.accumulation_steps, avg_cost))
    ...
    if not opts.no_tensorboard:
        ...
        tb_logger.log_value('ce_loss', loss.item() * opts.accumulation_steps, step)
